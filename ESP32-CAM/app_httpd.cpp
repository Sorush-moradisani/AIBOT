...
//
// Sorush: I made many alterations on this file its not like the original examples!
...
static int run_face_recognition(dl_matrix3du_t *image_matrix, box_array_t *net_boxes){
    ...
    if (align_face(net_boxes, image_matrix, aligned_face) == ESP_OK){
        if (is_enrolling == 1){
            ...
            if (matched_id == 0 || matched_id == 1) {
                ...
                rgb_printf(image_matrix, FACE_COLOR_GREEN, "Hello Sorush");
                
            }else if(matched_id >= 2){
                Serial.printf("Match Face ID: %u\n", matched_id);
                rgb_printf(image_matrix, FACE_COLOR_GREEN, "Hello Friend");
            } else {
                Serial.println("No Match Found");
                rgb_print(image_matrix, FACE_COLOR_RED, "Hey Stranger!");
                matched_id = -1;
            }
        }
    } else {
    ...
    return matched_id;
    if(deleteall){
      for(int i=2; i<id_list.count; i++){
        delete_face_id_in_flash(&id_list);
        Serial.print(id_list.count);
...
static esp_err_t cmd_handler(httpd_req_t *req){
    ...
    }else if(!strcmp(variable, "l-rotate")){
      Serial.println("l-rotate");
    }else if(!strcmp(variable, "stop")){
      Serial.println("stop");
    }else if(!strcmp(variable, "r-rotate")){
        Serial.println("r-rotate");
    }else if(!strcmp(variable, "f-left")){
        Serial.println("f-left");
    }else if(!strcmp(variable, "f-forward")){
        Serial.println("f-forward");
    }else if(!strcmp(variable, "f-right")){
        Serial.println("f-right");
    }else if(!strcmp(variable, "b-left")){
        Serial.println("b-left");
    }else if(!strcmp(variable, "b-backward")){
        Serial.println("b-backward");
    }else if(!strcmp(variable, "b-right")){
        Serial.println("b-right");
    }else if(!strcmp(variable, "light")){
        Serial.println("light");
    }else if(!strcmp(variable, "fire")){
        Serial.println("fire");
    }else if(!strcmp(variable, "ai")){
        Serial.println("ai");
    }else if(!strcmp(variable, "introduce")){
        Serial.println("introduce");
    }else if(!strcmp(variable, "greet")){
        Serial.println("greet");
    }else if(!strcmp(variable, "find")){
        Serial.println("find");
    }else if(!strcmp(variable, "follow")){
        Serial.println("follow");
    }else if(!strcmp(variable, "dance")){
        Serial.println("dance");
    }else if(!strcmp(variable, "random")){
        Serial.println("random");
    }else if(!strcmp(variable, "history")){
        Serial.println("history");
    }else if(!strcmp(variable, "hymn")){
        Serial.println("hymn");
    }else if(!strcmp(variable, "Scenes")){
        Serial.println("Scenes");
    }else if(!strcmp(variable, "ancient")){
        Serial.println("ancient");
    }else if(!strcmp(variable, "figure1")){
        Serial.println("figure1");
    }else if(!strcmp(variable, "optimus")){
        Serial.println("optimus");
    }else if(!strcmp(variable, "hreset")){
        Serial.println("hreset");
    }else if(!strcmp(variable, "reset")){
        Serial.println("reset");
    }else if(!strcmp(variable, "voicemode")){
        Serial.println("voicemode");
    }else if(!strcmp(variable, "stopseq")){
        Serial.println("stopseq");
        ...
        is_enrolling = 1;
    }else if(!strcmp(variable, "recognise")){
        detection_enabled = 1;
        ...
        Serial.print("pan=");
        Serial.println(val);
    }else if(!strcmp(variable, "lr-rhand")){
        Serial.print("lr-rhand=");
        Serial.println(val);
    }else if(!strcmp(variable, "ud-rhand")){
        Serial.print("ud-rhand=");
        Serial.println(val);
    }else if(!strcmp(variable, "lr-lhand")){
        Serial.print("lr-lhand=");
        Serial.println(val);
    }else if(!strcmp(variable, "ud-lhand")){
